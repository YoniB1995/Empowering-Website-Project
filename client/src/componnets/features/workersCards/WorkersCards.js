    ...
    <>
      ...
      >
        ...
        <div className="row active-with-click">
            ...
            <article className="material-card Green">
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-joaquin-phoenix.jpg"
                  />
                </div>
                <div className="mc-description">
                  is an American actor, producer, music video director, musician
                  and activist. For his work as an artist, Phoenix has received
                  a Grammy Award, a Golden Globe Award and three Academy ...
                </div>
              </div>
              <a className="mc-btn-action">
                <i className="fa fa-bars"></i>
            ...
            <article className="material-card Light-Green">
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-tom-hanks.jpg"
                  />
                </div>
                <div className="mc-description">
                  He is known for his roles in Big (1988), Philadelphia (1993),
                  Forrest Gump (1994), Apollo 13 (1995), Saving Private Ryan,
                  You've Got Mail (both 1998), The Green Mile (1999), Cast Away
                  (2000) ...
                </div>
              </div>
              <a className="mc-btn-action">
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <article className="material-card Lime">
              <h2>
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-philip-seymour-hoffman.jpg"
                  />
                </div>
                <div className="mc-description">
                  Best known for his distinctive supporting and character roles
                  – typically lowlifes, bullies, and misfits – Hoffman was a
                  regular presence in films from the early 1990s until his death
                  at age 46.
                </div>
              </div>
              <a className="mc-btn-action">
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <article className="material-card Yellow">
              <h2>
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-paul-newman.jpg"
                  />
                </div>
                <div className="mc-description">
                  He won numerous awards, including an Academy Award for his
                  performance in the 1986 film The Color of Money,[3] a BAFTA
                  Award, a Screen Actors Guild Award, a Cannes Film Festival
                  Award, an Emmy Award ...
                </div>
              </div>
              <a className="mc-btn-action">
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <article className="material-card Amber">
              <h2>
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-marlon-brando.jpg"
                  />
                </div>
                <div className="mc-description">
                  He is hailed for bringing a gripping realism to film acting,
                  and is frequently cited as the greatest and most influential
                  actor of all time.[2] A cultural icon, Brando is most famous
                  for his Academy ...
                </div>
              </div>
              <a className="mc-btn-action">
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <article className="material-card Orange">
              <h2>
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-kevin-spacey.jpg"
                  />
                </div>
                <div className="mc-description">
                  He began his career as a stage actor during the 1980s, before
                  being cast in supporting roles in film and television. He
                  gained critical acclaim in the early 1990s, culminating in his
                  first Academy Award ...
                </div>
              </div>
              <a className="mc-btn-action">
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <article className="material-card Deep-Orange">
              <h2>
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-robert-de-niro.jpg"
                  />
                </div>
                <div className="mc-description">
                  His first major film roles were in the sports drama Bang the
                  Drum Slowly (1973) and Martin Scorsese's crime film Mean
                  Streets (1973). In 1974, after being turned down for the role
                  of Sonny Corleone in the crime ...
                </div>
              </div>
              <a className="mc-btn-action">
                <i className="fa fa-bars"></i>
            ...
            <article className="material-card Brown">
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-steve-mcqueen.jpg"
                  />
                </div>
                <div className="mc-description">
                  Called "The King of Cool", his "anti-hero" persona, developed
                  at the height of the Vietnam War-era counterculture, made him
                  a top box-office draw of the 1960s and 1970s. McQueen received
            ...
            <article className="material-card Grey">
              ...
              <div className="mc-content">
                <div className="img-container">
                  <img
                    className="img-responsive"
                    src="https://material-cards.s3-eu-west-1.amazonaws.com/thumb-rugter-hauer.jpg"
                  />
                </div>
                <div className="mc-description">
                  Blonde, blue-eyed, tall and handsome Dutch actor Rutger Hauer
                  has an international reputation for playing everything from
                  romantic leads to action heroes to sinister villains. Hauer
                  was born in Breukelen, a town in the province ...
                </div>
              </div>
              <a className="mc-btn-action">
                <i className="fa fa-bars"></i>
