  ...
  return (
    <div className="staff-wrapper">
      ...
      <div className="staff-header-container">
        {isHebrew ?  <div className="staff-role-btn-container">
      ...
      <div className="our-team-wrapper">
        <div className="founder-card-container">
          <div className="founder-card">
            ...
            >
              <Meta
                title={<div> <h4>{isHebrew ? staffMembers[0].fullname : staffMembers[1].fullname}</h4><p>{isHebrew ? staffMembers[0].role : staffMembers[1].role}</p></div>}
