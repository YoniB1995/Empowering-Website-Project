<<<<<<< HEAD:client/src/componnets/pages/store/Store.js
...
const CommerceJs = () => {
  ...
  useEffect(() => {
    cart.line_items?.map((item) =>
      item.product_id === "prod_RqEv5xXOxk5Zz4"
        ? setIsCardOnCart(true)
        : setIsCardOnCart(false)
    );
  }, [cart]);
  ...
  // const ModalForm = () => {
  //     const [isModalVisible, setIsModalVisible] = useState(false);
>>>>>>> 801214e9cf53e82917e1a8c17d442a9e65de5b6d:client/src/componnets/pages/commerce/Commerce.js
...
>>>>>>> 801214e9cf53e82917e1a8c17d442a9e65de5b6d:client/src/componnets/pages/commerce/Commerce.js
          ...
          <div className="drawer">
            ...
            >
              ...
              <div className="subtotal">
                ...
                <Link
                  to={isCardOnCart ? "/Commercejs/CheckOut" : "/Commercejs/2"}
                >
                  <ButtonComponent
                    type="button"
                    text="לקופה"
  ...
  return (
    <div>
      <div>{!cart.line_items.length ? <EmptyCart /> : <FilledCart />}</div>
      <Switch>
