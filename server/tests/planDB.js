			...
			body: {
				...
				data: [
					...
					},
					{
						...
						title: "השכלה גבוהה",
						description:
							"תוכנית ההשכלה גבוהה תיתן הכוונה וייעוץ לנשים אשר מעוניינות ללמוד ולשפר את איכות חייהן וחיי משפחתן, התוכנית תחשוף בפני הנשים את המוסדות הלימוד ותוכניות הקיימות בכל הארץ ואף תסייע במציאת מלגות ונשאף אף למתן מלגות לימודים.",
